...
/* Standard interface: __MIDL_itf_AtmoWin_0000, ver. 0.0,
...
const CInterfaceProxyVtbl * _AtmoWin_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _AtmoWin_StubVtblList[] = 
{
