...
void CTrayIconWindow::createWindow() {
    ...
    res_buffer = getResStr(IDS_SETTINGS, "&Einstellungen");
    ...
    res_buffer = getResStr(IDS_MODUS, "Modus");
    ...
    res_buffer = getResStr(IDS_EFFECT_NONE, "kein Effekt");
    ...
    res_buffer = getResStr(IDS_CHANNELASSIGN, "Kanalzuordnung");
    ...
    res_buffer = getResStr(IDS_QUIT, "beenden");
